...
import paquete.tufanoapp.Item_objct;
import paquete.tufanoapp.R;

public class NavigationAdapter extends BaseAdapter
{
    private final Activity              activity;
    private final ArrayList<Item_objct> arrayitms;
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            convertView = inflator.inflate(R.layout.itm, parent, false);
            //Titulo
            ...
            //Icono
            view.icono = (RecyclingImageView) convertView.findViewById(R.id.icon);
            //Seteo el icono
